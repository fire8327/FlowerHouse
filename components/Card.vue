<template>
     <div class="flex flex-col gap-6">
        <img src="https://static.tildacdn.com/stor6135-3938-4736-b038-313639336661/93178138.jpg" alt="" class="rounded-xl">
        ...
        <div class="flex items-center gap-2 max-md:flex-col text-lg">
            ...
            <button class="md:w-3/5 px-4 py-2 text-center bg-[#569E0B] transition-all duration-500 hover:text-[#665E5E] text-white rounded-xl">В корзину</button>
        </div>
    </div>
</template>
